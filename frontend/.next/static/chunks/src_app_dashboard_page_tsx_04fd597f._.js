...
function DashboardPage() {
    ...
    const { user, isAuthenticated, token, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
    ...
    const handleLogout = ()=>{
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$features$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logout"])());
        router.push('/');
    };
...
_s(DashboardPage, "N+srdzencWEakBL5vf/L0SlYqLc=", false, function() {
    return [
